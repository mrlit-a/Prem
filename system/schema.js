module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['17869360209']
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/H7qcxZLQ91JGqkCLOKBX55'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: false,
         ...
         link: 'https://chat.whatsapp.com/H7qcxZLQ91JGqkCLOKBX55'
      }
   }
}
