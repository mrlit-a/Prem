"use strict";
require('./system/config'), require('events').EventEmitter.defaultMaxListeners = 15
...
const connect = async () => {
   ...
   client.ev.on('messages.upsert', async chatUpdate => {
      try {
         ...
         require('./system/scraper'), require('./system/function'), require('./system/baileys'), require('./handler')(client, m, plugins, store)
      } catch (e) {
         console.log(e)
      }
   })
